...
const vectors: Array<TestVector> = [
  ...
  // },
    ...
    coinType: 1129,
      passingVectors: [
      { text: 'dHmPhTMnnFg2jf1Esy4813kFCpWP6EtzeD', hex: '76a9142fade5f6d8fd1324c236f47a3c0cdc71d843e95f88ac' },
        { text: 'df1q4tc5anw0gckga9738954f5segtue3rkwn7ahxp', hex: '0014aaf14ecdcf462c8e97d1396954d21942f9988ece' },
    ],
  },
  // {
  //   name: 'XTZ',
